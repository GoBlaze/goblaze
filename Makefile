...
bench:
	@go test  -benchmem   -cpuprofile=cpu.prof -memprofile=mem.prof -benchtime=10s -timeout 220s -bench . -benchmem ./benchmarks -count 3
	

benchGC:
	@go test -gcflags="-e" -benchmem   -cpuprofile cpu.prof -memprofile mem.prof -benchtime=10s -timeout 220s -bench . -benchmem ./benchmarks -count 3
